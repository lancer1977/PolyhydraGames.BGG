...
solution_projects=(
  "$repo_root/PolyhydraGames.BGG.Test/PolyhydraGames.BGG.Test.csproj"
  "$repo_root/PolyhydraGames.BGG/PolyhydraGames.BGG.csproj"
  "$repo_root/PolyhydraGames.BGG.Data.Dapper/PolyhydraGames.BGG.Data.Dapper.csproj"
)

dotnet restore "${solution_projects[@]}"
dotnet test "$repo_root/PolyhydraGames.BGG.Test/PolyhydraGames.BGG.Test.csproj" --no-restore
dotnet pack "$repo_root/PolyhydraGames.BGG/PolyhydraGames.BGG.csproj" -c Release --no-restore -o "$repo_root/artifacts"
